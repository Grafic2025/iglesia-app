...
const AssignList: React.FC<AssignListProps> = ({ plans, memberId, onSelectPlan, fadeAnim, onRefresh }) => {
    if (plans.length === 0) {
        return (
...
const styles = StyleSheet.create({
    ...
    emptyIconCircle: {
        ...
        backgroundColor: '#050505', justifyContent: 'center', alignItems: 'center',
        borderWidth: 1, borderColor: '#111', borderStyle: 'dashed'
    },
    emptyTitle: { color: '#fff', fontSize: 22, fontFamily: 'Montserrat_900Black', marginTop: 25 },
    emptySub: { color: '#666', fontSize: 14, fontFamily: 'Inter_400Regular', textAlign: 'center', marginTop: 12, lineHeight: 22 },
    refreshListBtn: {
        marginTop: 35, backgroundColor: '#000', paddingHorizontal: 24, paddingVertical: 14,
        borderRadius: 20, borderWidth: 1, borderColor: '#1a1a1a', flexDirection: 'row',
    ...
    assignCard: {
        ...
        padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#151515'
    },
    assignCardPending: {
    ...
    assignTitle: { color: '#444', fontSize: 10, fontFamily: 'Montserrat_700Bold', letterSpacing: 1 },
