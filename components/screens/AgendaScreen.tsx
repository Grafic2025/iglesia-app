...
const AgendaScreen = ({ navigateTo }: any) => {
    ...
    return (
        <ScrollView
            ...
            contentContainerStyle={{ paddingBottom: 80, paddingTop: Math.max(insets.top, 16) }}
        ...
        >
            ...
            <View style={styles.infoFooter}>
                <BlurView intensity={15} tint="dark" style={styles.infoFooterBlur}>
...
const styles = StyleSheet.create({
    ...
    backButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.8)', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 22, borderWidth: 1, borderColor: '#333', alignSelf: 'flex-start', marginBottom: 20 },
    ...
    sectionLabel: { color: '#444', fontSize: 11, fontWeight: '900', letterSpacing: 2, marginBottom: 20 },

    agendaCard: { backgroundColor: '#111', borderRadius: 24, padding: 15, flexDirection: 'row', alignItems: 'center', marginBottom: 15, borderWidth: 1, borderColor: '#222' },
    ...
    timeTag: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1a1a1a', alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
    ...
    infoFooterText: { color: '#666', fontSize: 11, marginLeft: 15, flex: 1, lineHeight: 18, fontWeight: '500' },
});
